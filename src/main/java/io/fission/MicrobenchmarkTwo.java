...
public class MicrobenchmarkTwo implements Function {
    ...
    private static final String URL = "http://router.fission/hello2p";
    ...
    public ResponseEntity<?> call(RequestEntity req, Context context) {
        ...
        if (data == null || req.getMethod() == HttpMethod.GET) {
            ...
            for (int i = 0; i < INVOKE; i++) {
                ListenableFuture<Response> whenResponse = asyncHttpClient.preparePost(URL)
